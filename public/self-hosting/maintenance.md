...
This guidance moved to [Load balancers and reverse proxies](/self-hosting/configuration/reverse-proxy#client-ip-detection), together with the forwarded-header configuration for CSRF origin validation.
