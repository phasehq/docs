...
- **Teams** — Optional groups of members and service accounts that are granted access to Apps collectively, scoped to specific Environments. Available on Pro and Enterprise plans. See [Teams](/access-control/teams)
...
For the step-by-step process, see [Transfer Ownership](/console/organisation#transfer-ownership).
