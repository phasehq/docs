...
export const navigation = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: 'Next.js', href: '/sdks' },
      { title: 'Nuxt', href: '/sdks/js' },
      { title: 'Node.js', href: '/sdks/node' },
      { title: 'NestJS', href: '/sdks/python' },
      { title: 'React', href: '/sdks/python' },
      { title: 'Vue.js', href: '/sdks/python' },
      { title: 'Django', href: '/sdks/python' },
      { title: 'Flask', href: '/sdks/python' },
      { title: 'Svelte', href: '/sdks/python' },
      { title: 'Fiber', href: '/sdks/python' },
      { title: 'Ruby on Rails', href: '/sdks/python' },
      { title: '.NET', href: '/sdks/python' },
      { title: 'Laravel', href: '/sdks/python' },
      { title: 'Gatsby', href: '/sdks/python' },
      { title: 'Remix', href: '/sdks/python' },
    ],
  },
  {
    title: 'SDKs',
