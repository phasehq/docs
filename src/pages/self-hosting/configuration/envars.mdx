...
You can find instructions for settings up SSO with Google OAuth [here](https://support.google.com/cloud/answer/6158849?hl=en).
...
You can find instructions for settings up SSO with a GitHub OAuth App [here](https://docs.github.com/en/apps/oauth-apps/building-oauth-apps/creating-an-oauth-app).
...
You can find instructions for settings up SSO with a GitLab OAuth Application [here](https://docs.gitlab.com/ee/integration/oauth_provider.html).
...
<Properties>
  <Property name="DATABASE_HOST" type="string">
    ...
    <Note>
      Changing this value is not recommended unless you are also modifying the
