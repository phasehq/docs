...
<Properties>
  ...
  <Property name="NEXT_PUBLIC_GITHUB_INTEGRATION_CLIENT_ID" type="string">
    GitHub OAuth application Client ID for public use
  </Property>
...
<Properties>
  <Property name="NEXTAUTH_URL" type="string">
    The URL for NextAuth. References `${HTTP_PROTOCOL}${HOST}`
    
    Example: `https://[**YOUR_DOMAIN**]`
  </Property>
  <Property name="OAUTH_REDIRECT_URI" type="string">
    The OAuth redirect URI. References `${HTTP_PROTOCOL}${HOST}`
    
    Example: `https://[**YOUR_DOMAIN**]`
  </Property>
  <Property name="BACKEND_API_BASE" type="string">
    The base URL for the backend API. References `${HTTP_PROTOCOL}${HOST}/service`
    
    Example: `https://[**YOUR_DOMAIN**]/service`
  </Property>
  <Property name="NEXT_PUBLIC_BACKEND_API_BASE" type="string">
    The public base URL for the backend API. References `${HTTP_PROTOCOL}${HOST}/service`
  ...
  <Property name="ALLOWED_HOSTS" type="string">
    Comma-separated list of allowed hosts used the backend. References `${HOST},backend`
    
    Example: `[**YOUR_DOMAIN**],backend`
  </Property>
  <Property name="ALLOWED_ORIGINS" type="string">
    Comma-separated list of allowed origins used by Django. References `${HTTP_PROTOCOL}${HOST}`
    
    Example: `https://[**YOUR_DOMAIN**]`
  </Property>
  <Property name="SESSION_COOKIE_DOMAIN" type="string">
    Domain for the session cookie used by Django. References `${HOST}`
