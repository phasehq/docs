...
7. You should now be able to access the Phase console at `https://your-ec2-ip-address`. By default, Phase provisions a self-signed TLS certificate using Nginx. For production use, please configure a valid TLS certificate for your domain.
