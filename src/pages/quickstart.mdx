...
Alternatively, you can import your secrets by dragging and dropping your `.env` file into the Phase Console. This may be more suitable if you want to quickly import things like secrets and comments denoted by `#` from your `.env` file across many environments.
