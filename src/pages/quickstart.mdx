...
Lets get rid of our `.env` file now, its best practice not to leave secrets in plain text on disk:
...
To inject secrets locally into our application, simply prefix the normal command you would use with
