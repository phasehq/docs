...
Setup your account and start using Phase encryption in your App in in under 3 minutes ⏱️.
...
- [A hardware security module](https://en.wikipedia.org/wiki/Hardware_security_module) - Coming soon

Each method has its operational security tradeoffs and limitations.
...
Great, you're now set up with your Phase account and App keys in the Phase Console. Up next, [grab an SDK](/sdks) for your stack and start encrypting!
