...
Next, import your secrets from the `.env` file.
...
Alternatively, you can import your secrets by dragging and dropping your `.env` file into the App's environment in the Phase Console. This may be more suitable if you want to quickly import secrets and comments denoted by `#` from your `.env` file across multiple environments.
