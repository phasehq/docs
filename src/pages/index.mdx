...
Get setup with Phase in minutes by following the Quickstart guide. This Guide will walk you through setting up your account via the [Phase Console](/#phase-console), installing the [CLI](/#phase-cli) and importing secrets from your Project.
...
Mission Control for your app secrets and environment variables.

![phase console](/assets/images/console/phase-console-secrets.webp)
...
<div className="not-prose">
  <Button
    ...
    variant="text"
    arrow="right"
    children="Explore Phase Console"
  />
</div>
