...
- ⚡ Sane defaults: out of the box [dev, stag, prod environments](/console/environments) setup, logging, permissions etc.
- 🎯 [Inject secrets](/quickstart#3-inject-secrets) into any application or containers at runtime without any dependencies
...
- 👨‍💻 [Invite teammates](/console/users#add-users-to-an-organisation) and sync secrets like it's Google Docs
