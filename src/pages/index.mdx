...
- **Share** secrets with your [team](/console/users#invite-a-user-to-your-organisation) and manage access to secrets with [cryptographic RBAC](/console/environments#manage-user-access).
