...
export const sections = [
  ...
  { title: 'Types', id: 'type-references' }
]
...
<Note>
  To use the Node SDK, you need to create a new App on the Phase Console. Add the service token or user token (PAT) to your application, preferably using environment variables. [Quick start &raquo;](/quickstart)
</Note>
