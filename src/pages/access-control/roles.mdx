...
![2-switch-role.png](/assets/images/console/access-control/roles/switch-user-role/2-switch-role.png)
...
![3-click-create-role.png](/assets/images/console/access-control/roles/create-custom-roles/3-click-create-role.png)
3. Provide a name and description for the role. (Role name is mandatory)
![4-create-a-new-roole.png](/assets/images/console/access-control/roles/create-custom-roles/4-create-a-new-roole.png)
...
Some actions require varying degrees of permissions across multiple resources. Below is a list of permissions needed to perform such actions:
