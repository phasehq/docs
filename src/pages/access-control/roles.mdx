...
1. Navigate to Access Control tab and click on the Members section.
...
The organization owner. This role is automatically assigned when a user created a new organization. It is unique to a single user and grants access to all resources and actions.
...
1. Navigate to Access Control tab and click on the Roles section.
2. Click on "Create Role".
3. Provide a name and description for the role. (Role name in mandatory)
4. Expand the Organisation and the App permissions section by clicking on each of them and select the desired policy permissions by clicking the dropdown for each resource in the Access column and selecting one of the following:
    - 🚫 No access
    - 👁️ Read access
    - ❄️ Full access
    - 📝 Custom access
...
1. Navigate to Access Control tab and click on the Roles section.
2. Find the custom role you want to edit, hover on it and click ⚙️ Manage.
