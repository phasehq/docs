...
You can only select a role whose permissions your own role also has. The dropdown disables the other roles. This limit does not apply to users with the Owner or Admin role.
...
You can only select a role whose permissions your own role also has. This limit does not apply to users with the Owner or Admin role.
