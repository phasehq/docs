...
The role of the account can only have permissions that your own role has. If the team has a **Member role** override, Phase adds the permissions of that override to your own permissions for this check. This limit does not apply to users with the Owner or Admin role.
