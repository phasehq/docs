...
2. Under **Two-factor authentication**, click **Enable**. You may be asked to confirm it's you first — sensitive account changes require a recent session, and you are returned to setup after signing in again.
