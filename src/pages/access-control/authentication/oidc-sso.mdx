...
7.  You can find your Okta domain by clicking on the drop down in the top right corner and clicking the copy button on host listed under your name and email (e.g. `acme-1234567.okta.com`). Supply these configuration credentials, along with your Okta domain, make sure to prefix `https://` to the Okta domain (e.g., `https://acme-1234567.okta.com`), to your Phase Console deployment as [environment variables](/self-hosting/configuration/envars#okta-oidc).
