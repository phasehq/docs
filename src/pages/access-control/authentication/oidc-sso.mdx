...
You can use JumpCloud as an OIDC provider to set up SSO for your Phase application. Follow these steps to set up a JumpCloud SSO Application for Phase:
...
For more detailed information about JumpCloud SSO configuration, you can refer to the [official JumpCloud documentation](https://support.jumpcloud.com/s/article/Single-Sign-On-SSO-with-OIDC).
