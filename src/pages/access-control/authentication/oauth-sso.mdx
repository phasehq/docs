...
If you are using GitHub Enterprise (self-hosted) instance, you may follow the steps below to set up GitHub SSO for your Phase application as the instructions are nearly identical. The only exception being the Authorization callback URL.

<Note>
   GitHub Enterprise (self-hosted) instance for OAuth SSO is only available for organizations with an `Enterprise` tier subscription. See [Pricing](https://phase.dev/pricing).
</Note>
...
3. Fill in the application details:
   - Application name: "Phase Console"
   - Homepage URL: Your application's URL (e.g., https://[**YOUR_DOMAIN**].com)
   - Authorization callback URL: Your callback URL (e.g., https://[**YOUR_DOMAIN**].com/api/auth/callback/github) if you are using GitHub Enterprise (self-hosted) instance, please use https://[**YOUR_DOMAIN**].com/api/auth/callback/github-enterprise as the redirection URI.
...
3. Fill in the application details:
   - Name: "Phase Console SSO"
   - Redirect URI: Your callback URL (e.g., https://[**YOUR_DOMAIN**].com/api/auth/callback/gitlab)
   - Confidential: Check this box
   - Scopes: Select only "read_user"
