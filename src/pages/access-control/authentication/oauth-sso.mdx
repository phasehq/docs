...
3. Fill in the application details:
   ...
   - Authorization callback URL: Your callback URL (e.g., https://[**YOUR_DOMAIN**].com/api/auth/callback/github)
...
7. Supply these credentials to your Phase Console deployment as [environment variables](/self-hosting/configuration/envars#git-hub-sso).


You can find detailed official instructions for setting up SSO with a Google OAuth Application [here](https://docs.github.com/en/apps/oauth-apps/building-oauth-apps/creating-an-oauth-app). 
