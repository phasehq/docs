...
The Account page lets you manage everything about how you sign in to Phase. It is personal to you and applies across all of your organisations. Open it from the user menu in the top right corner of the Console — click your avatar and select **Account settings**.

<DocActions />

## Sensitive action re-authentication

Changes to your sign-in methods, email address, two-factor authentication, and account deletion require a recently authenticated session. If you signed in more than 15 minutes ago, Phase will ask you to sign in again before making changes. This limits what a stolen or unattended session can do. Self-hosted operators can tune this window with the [`AUTH_FRESHNESS_MAX_AGE_SECONDS`](/self-hosting/configuration/envars#additional-environment-variables) environment variable.
...
1. On the Account page, find **Sign-in methods**.
2. Under *Link a sign-in method*, click the provider you want to add. Providers configured on your instance are shown, along with any organisation-level SSO providers for organisations you are a member of.
...
Click **Unlink** next to a linked identity and confirm. You can no longer sign in with that identity afterwards. Unlinking is blocked when:
...
You can permanently delete your Phase account from the **Danger zone** on the Account page. Deletion is immediate and irreversible: your organisation memberships, encryption keys, personal access tokens, and personal data are permanently removed.
