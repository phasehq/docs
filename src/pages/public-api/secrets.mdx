...
<Row>
  <Col>
    ...
    Secret data must be supplied in the JSON request body. Each secret must have a key and value, and you can optionally add a comment, list of tags and a specified path.
...
<Row>
  <Col>
    ...
    Secret data must be supplied in the JSON request body. You must supply an `id` for each secret you want to update. Optionally you can supply the specific fields you wish to update for this secret.
