...
<Row>
  ...
  <Col sticky>
    ...
    func main() {
      ...
      url := "https://api.phase.dev/secrets/?app_id=72b9ddd5-8fce-49ab-89d9-c431d53a9552&env=development"
      method := "DELETE"
    ...
    url = URI("https://api.phase.dev/secrets/?app_id=72b9ddd5-8fce-49ab-89d9-c431d53a9552&env=development")
