...
and build your own automations for your stack. The API allows you to create, fetch, update and delete secrets accross all your Apps, Environments and Folders. {{ className: 'lead' }}
