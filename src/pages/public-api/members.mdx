...
<Row>
  <Col>
    ...
    Remove a member from the organisation. This is a soft-delete — the user's account is not deleted, and they can be re-invited later. Subsequent operations on the deleted member's ID return `404 Not Found`.
