...
<Row>
  <Col>
    ...
    - Callers cannot assign a role that includes permissions their own role does not have (`403`). The error lists each extra permission. Callers with a global-access role are exempt.
