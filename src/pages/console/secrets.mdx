...
You can also search for secrets across all Apps, Environments, and Folders in your organization that you have access to by triggering the command palette and typing secret key. You will see matching results listed with the App, Environment, and Path context of each secret.

<Note>
All secret searches are performed client side on in your browser on encrypted data regardless of App encryption mode. (End-to-end or Server-side Encryption)
</Note>
