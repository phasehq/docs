...
1. When your account is being setup, a cryptographically secure random seed is generated based on the bip-39 spec.
2. This seed is used to derive your account keys — an X25519 signing keypair.
3. You will be asked to setup a `sudo` password. This password is used to encrypt your account keys so they can be stored safely.
4. You will be provided with a recovery kit. This kit contains a recovery phrase that can be used to derive your account keys if you forget your `sudo` password.
