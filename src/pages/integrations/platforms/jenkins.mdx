...
<Note>
Please make sure to set a version tag for the `phsaehq/cli` docker image to avoid breaking changes. You can get the latest tags on [Docker Hub](https://hub.docker.com/r/phasehq/cli/tags).
</Note>
