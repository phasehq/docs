...
3. You will be redirected to GitHub to authorize Phase Integration. **Make sure to grant access to any organisations that you wish to integrate Phase with**. Click Authorize to continue.
