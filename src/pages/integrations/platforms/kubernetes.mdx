...
- Obtain a [`PHASE_SERVICE_TOKEN`](/access-control/service-accounts#create-a-new-service-account-token) for your application, that has access to the environment you are trying to fetch secrets from.
