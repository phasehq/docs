      ...
      - job: Prepare
        steps:
          ...
          - script: |
              ...
              echo "##vso[task.setvariable variable=DOCKERHUB_USERNAME;]$(phase secrets export --env prod DOCKERHUB_USERNAME | cut -d '=' -f2)"
              echo "##vso[task.setvariable variable=DOCKERHUB_TOKEN;]$(phase secrets export --env prod DOCKERHUB_TOKEN | cut -d '=' -f2)"
