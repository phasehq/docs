...
4. Create a new **Token** with a descriptive name (eg. `phase-console-vercel-sync`) , set the **Scope** to `Full Account` and **Expiration** to `No Expiration` and click **Create**. 
...
**ADD VERCEL SCREENSHOT HERE**

3. Paste your `Vercel Token` and add a descriptive name for the service credential and click **Save**
