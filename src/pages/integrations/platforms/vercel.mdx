...
<Note>
Environment variables scoped to 'All Environments' in Vercel will not be overwritten, and may lead to duplicate environment variables if the same key exists in Phase. Vercel will prioritize environment variables scoped to specific environments over those scoped to 'All Environments'.
</Note>
