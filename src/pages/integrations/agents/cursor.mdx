...
export const description = 'Integrate Phase with Cursor'

<Tag variant="small">INTEGRATE</Tag>

# Cursor

Manage Phase secrets directly from [Cursor](https://cursor.com) Agent. Cursor can list, create, update, and delete secrets, run processes with injected secrets, and manage your Phase environments — all from natural language.
