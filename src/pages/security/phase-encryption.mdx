...
<Note>
  ...
  **Signing Keys** are generated deterministically with client-sided crypto on
  your own machine and never transmitted or stored on Phase backend
  infrastructure.
</Note>

- On device, encrypted with sudo password
  - Why?
  - sudo password → encryption key? (Argon2ID + params)
  - Encrypted with XChaChaPoly1305
- public key on backend in plaintext
- How can I retrieve them?
  - Mnemonic phrase
  - New device login
  - Key derivation from seed process
  - Validation with public key on backend

## App keys & secret generation

- What they are used for
- How are they generated?
  - App seed (`crypto_kdf_keygen()`)
  - App seed → app Keyring
    - `crypto_kx_seed_keypair()`
  - App token
    - What is it for?
    - How is it generated? `crypto_kdf_keygen()`
  - App wrap key
    - What is it for?
    - How is generated? `crypto_kdf_keygen()`
- App key shares?
  - Why?
  - How are keys split?
  - Wrapped key
