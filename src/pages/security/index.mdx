...
Phases uses strong and robust cryptographic libraries and implementations such as [libsodium](https://doc.libsodium.org/) which have gone though a formal audit. [More about the audit](https://www.privateinternetaccess.com/blog/libsodium-v1-0-12-and-v1-0-13-security-assessment/)

---

## Account

Your Phase account is more than just a way to login and access the console. It is associated with cryptographic keys which help secure your Apps, and ensure that sensitive "admin" operations can only be performed by you.
...
The recovery phrase is used to derive the following cryptographic keys which comprise your Account Keyring:
