...
Phases uses strong and robust cryptographic libraries and implementations such as [libsodium](https://doc.libsodium.org/) which have gone though a formal audit. We plan to go through a similar formal security assessment and audit with the Phase Console.
