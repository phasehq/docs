...
# Non-interactive
> phase ai enable --mask --target ~/.claude/skills/phase-cli/SKILL.md
> phase ai enable --no-mask --target ~/.cursor/skills/phase-cli/SKILL.md
```
...
👀 Allow AI agents to view secret values? Sealed secrets are never revealed!
