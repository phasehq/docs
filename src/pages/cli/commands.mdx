...
- When monorepo support is enabled, the CLI will search parent directories for a `.phase.json` config, making it ideal for projects with multiple services or packages.
