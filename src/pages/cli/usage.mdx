...
Alternatively, authenticate with Phase via a [Service Token](/console/tokens#service-tokens). This is suitable for using the CLI in a headless environment such as on your server, remote machine via SSH, Docker container, etc.
