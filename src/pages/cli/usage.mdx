...
Authenticate with Phase via a [Service Token](/console/tokens#service-tokens). This is suitable for using the CLI on your server, remote machine, Docker container, etc.
